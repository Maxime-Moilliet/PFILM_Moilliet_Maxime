...
class SelectMovies {
    ...
    constructor(movies) {
        ...
        this.fakeAsyncFunction = this.fakeAsyncFunction.bind(this)
     ...
     */
     async handleClick(e) {
        const container = document.querySelector('.js-swiper-movies .swiper-wrapper')
    ...
    fakeAsyncFunction(callback, time) {
        return new Promise(() => {
          setTimeout(() => {
            callback()
          }, time);
     ...
     */
    getMoviesDay() {
        return this.movies.filter(el => el.day_visible === this.lastestElementClick)
    }
     ...
     */
    clearSwiperSlideDOM() {
        const cards = Array.from(document.querySelectorAll('.js-swiper-movies .swiper-slide'))
        cards.forEach(el => {
...
class CreateCardMovieDOM {
    ...
    constructor(data) {
        ...
        this.container = document.querySelector('.js-swiper-movies .swiper-wrapper')
        this.data = data
    ...
    createCardMovie() {
        ...
        card.innerHTML = `
            <div class="movies__card" id="${this.data.id}">
                <img src="${this.data.image_url}" alt="${this.data.image_alt}">
                <div>
